...
namespace NetCoreServer
{
    ...
    public class TcpClient : IDisposable
    {
        ...
        public virtual bool ConnectAsync()
        {
            ...
            _connectEventArg.RemoteEndPoint = Endpoint;
            _connectEventArg.Completed += OnAsyncCompleted;
            _connectEventArg.UserToken = "TestObject123";
        ...
        private void OnAsyncCompleted(object sender, SocketAsyncEventArgs e)
        {
            ...
            //_logger?.Log("OnAsyncCompleted: SocketAsyncEventArgs UserToken: " + e.Offset + " SendPacketsFlags: " + e.SendPacketsFlags + " BytesTransferred: " + e.BytesTransferred + " Offset: " + e.Offset);
            //_logger?.Log("OnAsyncCompleted: _receiveBuffer Capacity: " + _receiveBuffer.Capacity + " Size: " + _receiveBuffer.Size + " Offset: " + _receiveBuffer.Offset);
        ...
        private bool ProcessReceive(SocketAsyncEventArgs e)
        {
            ...
            //_logger?.Log("ProcessReceive UserToken: " + e.UserToken + " Offset: " + e.Offset + " Buffer: " + e.Buffer.Length);
            //_logger?.Log("ProcessReceive _receiveBuffer Length: " + _receiveBuffer.Data.Length + " Capacity: " + _receiveBuffer.Capacity);
