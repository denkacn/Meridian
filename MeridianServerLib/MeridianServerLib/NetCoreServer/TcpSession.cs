...
namespace NetCoreServer
{
    ...
    public class TcpSession : IDisposable
    {
        ...
        internal void Connect(Socket socket, object userToken)
        {
            Socket = socket;
            ...
            if (Server.OptionKeepAlive)
            {
	            ...
	            SetKeepAlive(Socket, true, 3_000, 1_000);
            }
        ...
        private void SetKeepAlive(Socket socket, bool enable, uint keepAliveTime, uint keepAliveInterval)
        {
	        ...
	        BitConverter.GetBytes((uint)(enable ? 1 : 0)).CopyTo(inOptionValues, 0);   // Включение (1) / Выключение (0)
	        BitConverter.GetBytes(keepAliveTime).CopyTo(inOptionValues, 4);           // Время без активности (мс)
	        BitConverter.GetBytes(keepAliveInterval).CopyTo(inOptionValues, 8);       // Интервал повторных проверок (мс)
        ...
        public virtual bool SendAsync(ReadOnlySpan<byte> buffer)
        {
            ...
            lock (_sendLock)
            {
                ...
                //_logger.Log("[TcpSession] SendAsync BytesPending: " + BytesPending);
        ...
        private void TrySend()
        {
            ...
            while (process)
            {
                ...
                try
                {
                    //_logger.Log("[TcpSession] TrySend Length: " + _sendBufferFlush.Data.Length + " _sendBufferFlushOffset: " + (int)_sendBufferFlushOffset + " Size: " + (int)(_sendBufferFlush.Size - _sendBufferFlushOffset));
        ...
        private bool ProcessSend(SocketAsyncEventArgs e)
        {
           ...
           // _logger.Log("[TcpSession] ProcessSend BytesTransferred: " + e.BytesTransferred);
        ...
        /// </summary>
        protected virtual void OnConnected(object userToken) {}
        /// <summary>
